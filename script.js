...
// let helou = isBirthday ? "Felizz Aniversário Kuromiii" : "Bom dia Kuromiiii" // Fazendo com variável

// console.log(helou)

// let isBirthday = confirm("é niver da kuromi?"); //Outra forma de fazer, confirmando com o usuário

// isBirthday ? console.log("Felizz Aniversário Kuromiii") : console.log("Bom dia Kuromiiii") // Outra forma de fazer, utilizando o console.log dentro.
...
// let cats = ["Kuromi", "Kitty", "Purim", "Roll", "Retsuko"] // nomes em lista
// let info = "My cats are called: " // frase que irá dizer
// let i = 0; // começará com 0

// while (i < cats.length){ // enquanto o i for menor que o tamanho da lista da variavel cats
//     if (i === cats.length-1){ // quando o i for igual ao tamanho da lista menos 1
//         info+= "and " + cats[i] + "."; // coloca um and no info + soma do ultimo gato + ponto final
//     } else { // se não
//         info += cats[i] + ", "; // continua a somar os gatos e colocar , entre eles
//     }

//     i ++ // vai somando cada um
// }
